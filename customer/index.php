				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="index.php" class="menu__link">HI, <?php echo $filtervalues;?> </a></li>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="order.php"><h2>ORDER NOW</h2></a>
</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			<h4>Locate Us</h4>
			<p class="contact-agile1"><strong>Phone :</strong> +6010-665-1561</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">order.saladatelier@gmail.com</a></p>
